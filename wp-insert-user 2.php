...
function buddyforms_wp_insert_user() {
	...
	// Envio de informações de cadastro via api entre comunidade e ações

	$url = "https://novoolharrua.org/acoes/Web/Services/index.php/Authentication/Authenticate";



	$authacoes = array(
		'username'      => 'adminlcomunicacao',
		'password'       => '123456',
	);


	$content = json_encode($authacoes);
	...
	$authcomunidade = json_decode($json_response);
	...
	$url2 = "https://novoolharrua.org/acoes/Web/Services/index.php/Users/";
	...
	$content1 = json_encode($jsonacoes);
	...
	curl_setopt($curl, CURLOPT_HTTPHEADER,
			...
			curl_setopt($curl, CURLOPT_HTTPHEADER, array(
				'X-Booked-SessionToken: '.$authcomunidade->sessionToken.'',
				'X-Booked-UserId: '.$authcomunidade->userId.''
			));
	curl_setopt($curl, CURLOPT_POST, true);
